    ...
    <>
      <div id="editModal" className="modal">
          ...
          <div className="row grey lighten-3">
            <div className="col s12">
              <ul className="tabs z-depth-1">
                <li className="tab col s6"><a className="active" href="#details">Details</a></li>
        ...
        <div className="modal-footer">
          <button className="btn-flat grey waves-effect waves-light" onClick={() => props.showModal(false)}>Close</button>
        </div>
      </div >
      <div className="darkness" onClick={() => props.showModal(false)} />
    </>
  )
}
